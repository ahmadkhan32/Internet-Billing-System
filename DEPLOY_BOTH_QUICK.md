# ⚡ Quick Deploy - Frontend & Backend (Copy-Paste Guide)

## 🎯 Goal: Deploy Both Projects in 15 Minutes

---

## 🔐 Backend Environment Variables (Copy These)

**Go to:** Vercel → Backend Project → Settings → Environment Variables

**Add these 14 variables (one by one):**
...
## 🎨 Frontend Environment Variable (Copy This)
...
1. **Backend**: `https://your-backend.vercel.app/api/health`
2. **Frontend**: `https://your-frontend.vercel.app`
3. **Login**: Use credentials above

---

**See `SIMPLE_DEPLOY_BOTH.md` for detailed step-by-step instructions!**
